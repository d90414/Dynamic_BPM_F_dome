...
angular.module('ASS.stockRiskTest').controller('stockRiskTestCtrl', ['$rootScope', '$scope', '$state', '$stateParams', '$localStorage', 'kibhSystem', function ($rootScope, $scope, $state, $stateParams, $localStorage, kibhSystem) {
