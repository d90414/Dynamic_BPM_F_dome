...
angular.module('ASS.otcRiskTest').controller('otcRiskTestCtrl', ['$scope', '$state', '$stateParams', '$localStorage', 'kibhSystem', function ($scope, $state, $stateParams, $localStorage, kibhSystem) {
