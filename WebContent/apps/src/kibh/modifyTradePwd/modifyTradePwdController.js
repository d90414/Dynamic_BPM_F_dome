...
angular.module('ASS.modifyTradePwd').controller('modifyTradePwdCtrl', ['$scope', '$state', '$stateParams', '$localStorage', 'kibhSystem', 'kibhAccount', 'myConfirm', function ($scope, $state, $stateParams, $localStorage, kibhSystem, kibhAccount, myConfirm) {
