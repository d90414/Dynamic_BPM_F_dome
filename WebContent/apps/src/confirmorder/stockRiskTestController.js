...
angular.module('ASS.confirmorder').controller('stockRiskTestCtrl', ['$scope', '$state', '$stateParams', '$localStorage', 'kibhSystem', function ($scope, $state, $stateParams, $localStorage, kibhSystem) {
    $scope.bizid = $localStorage.menubiz[$stateParams.businessId];
